...
sub _generate_bsub_command {
  ...
  $bsub_command .=  q{'} . $archive_script . q{ --samtools_cmd samtools1_1 --exclude_bam_index --exclude_bam --archive_path } . $self->archive_path() . q{ --runfolder_path } . $self->runfolder_path() . q{ --id_run } . $self->id_run();
