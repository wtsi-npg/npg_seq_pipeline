...
###
  ...
  return join q( ),
    ...
    q(-export_param_vals), qq(${name_root}_p4s2_pv_out_${id}_\${log_label}.json),
    ...
    qq(> run_${name_root}_\${log_label}.json),
    q{&&},
    qq(viv.pl -s -x -v 3 -o viv_${name_root}_\${log_label}.log run_${name_root}_\${log_label}.json ),
    q{&&},
