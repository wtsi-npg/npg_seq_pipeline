...
`mkdir -p $dir/references/Homo_sapiens/default/all/bwa0_6`;
`touch $dir/references/Homo_sapiens/default/all/bwa0_6/human.fa`;
`mkdir -p $dir/references/Homo_sapiens/default/all/fasta`;
`touch $dir/references/Homo_sapiens/default/all/fasta/human.fa`;
`mkdir -p $dir/references/Homo_sapiens/default/all/picard`;
`touch $dir/references/Homo_sapiens/default/all/picard/human.fa`;
