...
my $required_job_completion = q{-w'done(123) && done(321)'};

{
  ...
  my $bsub_command = $sr->_generate_bsub_command($required_job_completion);
  my $expected_cmd =  q{bsub -w'done(123) && done(321)' -J save_run_status_1234_run_archived_20090709-123456 -q small -o } . $log_dir . q{/save_run_status_1234_run_archived_20090709-123456.out 'npg_status2file --id_run 1234 --status "run archived" --dir_out }. $status_dir . q{'};
  ...
  $bsub_command = $sr->_generate_bsub_command($required_job_completion);
  $expected_cmd =  q{bsub -w'done(123) && done(321)' -J save_lane_status_1234_analysis_in_progress_20090709-123456 -q small -o } . $log_dir . q{/save_lane_status_1234_analysis_in_progress_20090709-123456.out 'npg_status2file --id_run 1234 --status "analysis in progress" --dir_out } . $status_dir . q{ --lanes 3 --lanes 4 --lanes 5'};
