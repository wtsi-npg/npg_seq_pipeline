...
subtest 'basic functionality' => sub {
  ...
  my $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/12597_4#3_p4s2_pv_in.json -export_param_vals 12597_4#3_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_12597_4#3_\${log_label}.json && viv.pl -s -x -v 3 -o viv_12597_4#3_\${log_label}.log run_12597_4#3_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/12597_4#0_p4s2_pv_in.json -export_param_vals 12597_4#0_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_12597_4#0_\${log_label}.json && viv.pl -s -x -v 3 -o viv_12597_4#0_\${log_label}.log run_12597_4#0_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/12597_5#168_p4s2_pv_in.json -export_param_vals 12597_5#168_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_12597_5#168_\${log_label}.json && viv.pl -s -x -v 3 -o viv_12597_5#168_\${log_label}.log run_12597_5#168_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $lane_temp_dir ; cd $lane_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/12597_1_p4s2_pv_in.json -export_param_vals 12597_1_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_12597_1_\${log_label}.json && viv.pl -s -x -v 3 -o viv_12597_1_\${log_label}.log run_12597_1_\${log_label}.json } .
...
# Edited to add 1000Genomes_hs37d5 + ensembl_75_transcriptome to lane 8
  ...
  my $command = qq{bash -c ' mkdir -p $lane_temp_dir ; cd $lane_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/13066_8_p4s2_pv_in.json -export_param_vals 13066_8_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_13066_8_\${log_label}.json && viv.pl -s -x -v 3 -o viv_13066_8_\${log_label}.log run_13066_8_\${log_label}.json } .
...
subtest 'test 3' => sub {
  ...
  my $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/no_cal/18472_2#1_p4s2_pv_in.json -export_param_vals 18472_2#1_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_18472_2#1_\${log_label}.json && viv.pl -s -x -v 3 -o viv_18472_2#1_\${log_label}.log run_18472_2#1_\${log_label}.json } .
...
subtest 'test 4' => sub {
  ...
  my $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16839_7#7_p4s2_pv_in.json -export_param_vals 16839_7#7_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_16839_7#7_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16839_7#7_\${log_label}.log run_16839_7#7_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16839_7#15_p4s2_pv_in.json -export_param_vals 16839_7#15_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_16839_7#15_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16839_7#15_\${log_label}.log run_16839_7#15_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16839_7#0_p4s2_pv_in.json -export_param_vals 16839_7#0_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_16839_7#0_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16839_7#0_\${log_label}.log run_16839_7#0_\${log_label}.json } .
...
subtest 'Newer flowcell' => sub {
  ...
  my $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16807_6#1_p4s2_pv_in.json -export_param_vals 16807_6#1_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_16807_6#1_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16807_6#1_\${log_label}.log run_16807_6#1_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16807_6#2_p4s2_pv_in.json -export_param_vals 16807_6#2_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_16807_6#2_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16807_6#2_\${log_label}.log run_16807_6#2_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16807_6#0_p4s2_pv_in.json -export_param_vals 16807_6#0_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_16807_6#0_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16807_6#0_\${log_label}.log run_16807_6#0_\${log_label}.json } .
...
subtest 'MiSeq WES baits' => sub {
  ...
  my $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/20268_1#1_p4s2_pv_in.json -export_param_vals 20268_1#1_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_20268_1#1_\${log_label}.json && viv.pl -s -x -v 3 -o viv_20268_1#1_\${log_label}.log run_20268_1#1_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/20268_1#2_p4s2_pv_in.json -export_param_vals 20268_1#2_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_20268_1#2_\${log_label}.json && viv.pl -s -x -v 3 -o viv_20268_1#2_\${log_label}.log run_20268_1#2_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/20268_1#0_p4s2_pv_in.json -export_param_vals 20268_1#0_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_20268_1#0_\${log_label}.json && viv.pl -s -x -v 3 -o viv_20268_1#0_\${log_label}.log run_20268_1#0_\${log_label}.json } .
...
subtest 'cycle count over threshold' => sub {
 ...
 local $ENV{NPG_CACHED_SAMPLESHEET_FILE} = q[t/data/miseq/samplesheet_16850.csv];
  ...
  my $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16850_1#1_p4s2_pv_in.json -export_param_vals 16850_1#1_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_16850_1#1_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16850_1#1_\${log_label}.log run_16850_1#1_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16850_1#2_p4s2_pv_in.json -export_param_vals 16850_1#2_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_16850_1#2_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16850_1#2_\${log_label}.log run_16850_1#2_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16850_1#0_p4s2_pv_in.json -export_param_vals 16850_1#0_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_16850_1#0_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16850_1#0_\${log_label}.log run_16850_1#0_\${log_label}.json } .
...
subtest 'nonconsented human split, no target alignment' => sub {
  ...
  my $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16756_1#1_p4s2_pv_in.json -export_param_vals 16756_1#1_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_humansplit_template.json > run_16756_1#1_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16756_1#1_\${log_label}.log run_16756_1#1_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16756_1#2_p4s2_pv_in.json -export_param_vals 16756_1#2_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_humansplit_template.json > run_16756_1#2_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16756_1#2_\${log_label}.log run_16756_1#2_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16756_1#0_p4s2_pv_in.json -export_param_vals 16756_1#0_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_humansplit_template.json > run_16756_1#0_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16756_1#0_\${log_label}.log run_16756_1#0_\${log_label}.json } .
...
subtest 'nonconsented human split, target alignment' => sub {
  ...
  my $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16866_1#1_p4s2_pv_in.json -export_param_vals 16866_1#1_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_humansplit_template.json > run_16866_1#1_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16866_1#1_\${log_label}.log run_16866_1#1_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16866_1#2_p4s2_pv_in.json -export_param_vals 16866_1#2_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_humansplit_template.json > run_16866_1#2_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16866_1#2_\${log_label}.log run_16866_1#2_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16866_1#0_p4s2_pv_in.json -export_param_vals 16866_1#0_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_humansplit_template.json > run_16866_1#0_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16866_1#0_\${log_label}.log run_16866_1#0_\${log_label}.json } .
...
subtest 'no target alignment, no human split' => sub {
  ...
  my $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/20990_1#1_p4s2_pv_in.json -export_param_vals 20990_1#1_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_20990_1#1_\${log_label}.json && viv.pl -s -x -v 3 -o viv_20990_1#1_\${log_label}.log run_20990_1#1_\${log_label}.json  && qc --check bam_flagstats --filename_root 20990_1#1 --qc_in $qc_in --qc_out $qc_out --rpt_list "20990:1:1" --input_files $dir/161010_MS5_20990_A_MS4548606-300V2/Data/Intensities/BAM_basecalls_20161011-102905/no_cal/archive/lane1/plex1/20990_1#1.cram --skip_markdups_metrics && qc --check bam_flagstats --filename_root 20990_1#1_phix --qc_in $qc_in --qc_out $qc_out --rpt_list "20990:1:1" --subset phix --input_files $dir/161010_MS5_20990_A_MS4548606-300V2/Data/Intensities/BAM_basecalls_20161011-102905/no_cal/archive/lane1/plex1/20990_1#1.cram --skip_markdups_metrics && qc --check alignment_filter_metrics --filename_root 20990_1#1 --qc_in \$PWD --qc_out $qc_out --rpt_list "20990:1:1" --input_files 20990_1#1_bam_alignment_filter_metrics.json '};
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $dir/161010_MS5_20990_A_MS4548606-300V2/Data/Intensities/BAM_basecalls_20161011-102905/no_cal/20990_1#0_p4s2_pv_in.json -export_param_vals 20990_1#0_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_20990_1#0_\${log_label}.json && viv.pl -s -x -v 3 -o viv_20990_1#0_\${log_label}.log run_20990_1#0_\${log_label}.json  && qc --check bam_flagstats --filename_root 20990_1#0 --qc_in $qc_in --qc_out $qc_out --rpt_list "20990:1:0" --input_files $dir/161010_MS5_20990_A_MS4548606-300V2/Data/Intensities/BAM_basecalls_20161011-102905/no_cal/archive/lane1/plex0/20990_1#0.cram --skip_markdups_metrics && qc --check bam_flagstats --filename_root 20990_1#0_phix --qc_in $qc_in --qc_out $qc_out --rpt_list "20990:1:0" --subset phix --input_files $dir/161010_MS5_20990_A_MS4548606-300V2/Data/Intensities/BAM_basecalls_20161011-102905/no_cal/archive/lane1/plex0/20990_1#0.cram --skip_markdups_metrics && qc --check alignment_filter_metrics --filename_root 20990_1#0 --qc_in \$PWD --qc_out $qc_out --rpt_list "20990:1:0" --input_files 20990_1#0_bam_alignment_filter_metrics.json '};
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/20990_1#2_p4s2_pv_in.json -export_param_vals 20990_1#2_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_20990_1#2_\${log_label}.json && viv.pl -s -x -v 3 -o viv_20990_1#2_\${log_label}.log run_20990_1#2_\${log_label}.json  && qc --check bam_flagstats --filename_root 20990_1#2 --qc_in $qc_in --qc_out $qc_out --rpt_list "20990:1:2" --input_files $dir/161010_MS5_20990_A_MS4548606-300V2/Data/Intensities/BAM_basecalls_20161011-102905/no_cal/archive/lane1/plex2/20990_1#2.cram --skip_markdups_metrics && qc --check bam_flagstats --filename_root 20990_1#2_phix --qc_in $qc_in --qc_out $qc_out --rpt_list "20990:1:2" --subset phix --input_files $dir/161010_MS5_20990_A_MS4548606-300V2/Data/Intensities/BAM_basecalls_20161011-102905/no_cal/archive/lane1/plex2/20990_1#2.cram --skip_markdups_metrics && qc --check alignment_filter_metrics --filename_root 20990_1#2 --qc_in \$PWD --qc_out $qc_out --rpt_list "20990:1:2" --input_files 20990_1#2_bam_alignment_filter_metrics.json '};
...
subtest 'chromium' => sub {
  ...
  my $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16839_1#1_p4s2_pv_in.json -export_param_vals 16839_1#1_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_16839_1#1_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16839_1#1_\${log_label}.log run_16839_1#1_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16839_1#9_p4s2_pv_in.json -export_param_vals 16839_1#9_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_16839_1#9_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16839_1#9_\${log_label}.log run_16839_1#9_\${log_label}.json } .
  ...
  $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/16839_1#0_p4s2_pv_in.json -export_param_vals 16839_1#0_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_16839_1#0_\${log_label}.json && viv.pl -s -x -v 3 -o viv_16839_1#0_\${log_label}.log run_16839_1#0_\${log_label}.json } .
...
subtest 'miseq' => sub {
  ...
  my $command = qq{bash -c ' mkdir -p $tmp_plex_dir ; cd $tmp_plex_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/24135_1#1_p4s2_pv_in.json -export_param_vals 24135_1#1_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_24135_1#1_\${log_label}.json && viv.pl -s -x -v 3 -o viv_24135_1#1_\${log_label}.log run_24135_1#1_\${log_label}.json  && qc --check bam_flagstats --filename_root 24135_1#1 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:1" --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex1/24135_1#1.cram --skip_markdups_metrics && qc --check bam_flagstats --filename_root 24135_1#1_phix --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:1" --subset phix --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex1/24135_1#1.cram --skip_markdups_metrics && qc --check alignment_filter_metrics --filename_root 24135_1#1 --qc_in \$PWD --qc_out $qc_out --rpt_list "24135:1:1" --input_files 24135_1#1_bam_alignment_filter_metrics.json && qc --check genotype_call --filename_root 24135_1#1 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:1" && qc --check substitution_metrics --filename_root 24135_1#1 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:1" --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex1/24135_1#1.cram '};
  ...
  $command = qq{bash -c ' mkdir -p $tmp_plex_dir ; cd $tmp_plex_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/24135_1#0_p4s2_pv_in.json -export_param_vals 24135_1#0_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_24135_1#0_\${log_label}.json && viv.pl -s -x -v 3 -o viv_24135_1#0_\${log_label}.log run_24135_1#0_\${log_label}.json  && qc --check bam_flagstats --filename_root 24135_1#0 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:0" --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex0/24135_1#0.cram --skip_markdups_metrics && qc --check bam_flagstats --filename_root 24135_1#0_phix --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:0" --subset phix --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex0/24135_1#0.cram --skip_markdups_metrics && qc --check alignment_filter_metrics --filename_root 24135_1#0 --qc_in \$PWD --qc_out $qc_out --rpt_list "24135:1:0" --input_files 24135_1#0_bam_alignment_filter_metrics.json '};
  ...
  $command = qq{bash -c ' mkdir -p $tmp_plex_dir ; cd $tmp_plex_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/24135_1#2_p4s2_pv_in.json -export_param_vals 24135_1#2_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_24135_1#2_\${log_label}.json && viv.pl -s -x -v 3 -o viv_24135_1#2_\${log_label}.log run_24135_1#2_\${log_label}.json  && qc --check bam_flagstats --filename_root 24135_1#2 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:2" --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex2/24135_1#2.cram --skip_markdups_metrics && qc --check bam_flagstats --filename_root 24135_1#2_phix --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:2" --subset phix --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex2/24135_1#2.cram --skip_markdups_metrics && qc --check alignment_filter_metrics --filename_root 24135_1#2 --qc_in \$PWD --qc_out $qc_out --rpt_list "24135:1:2" --input_files 24135_1#2_bam_alignment_filter_metrics.json && qc --check genotype_call --filename_root 24135_1#2 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:2" && qc --check substitution_metrics --filename_root 24135_1#2 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:2" --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex2/24135_1#2.cram '};
  ...
  $command = qq{bash -c ' mkdir -p $tmp_plex_dir ; cd $tmp_plex_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/24135_1#3_p4s2_pv_in.json -export_param_vals 24135_1#3_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_24135_1#3_\${log_label}.json && viv.pl -s -x -v 3 -o viv_24135_1#3_\${log_label}.log run_24135_1#3_\${log_label}.json  && qc --check bam_flagstats --filename_root 24135_1#3 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:3" --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex3/24135_1#3.cram && qc --check bam_flagstats --filename_root 24135_1#3_phix --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:3" --subset phix --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex3/24135_1#3.cram --skip_markdups_metrics && qc --check alignment_filter_metrics --filename_root 24135_1#3 --qc_in \$PWD --qc_out $qc_out --rpt_list "24135:1:3" --input_files 24135_1#3_bam_alignment_filter_metrics.json && qc --check substitution_metrics --filename_root 24135_1#3 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:3" --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex3/24135_1#3.cram '};
  ...
  $command = qq{bash -c ' mkdir -p $tmp_plex_dir ; cd $tmp_plex_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/24135_1#4_p4s2_pv_in.json -export_param_vals 24135_1#4_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_24135_1#4_\${log_label}.json && viv.pl -s -x -v 3 -o viv_24135_1#4_\${log_label}.log run_24135_1#4_\${log_label}.json  && qc --check bam_flagstats --filename_root 24135_1#4 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:4" --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex4/24135_1#4.cram --skip_markdups_metrics && qc --check bam_flagstats --filename_root 24135_1#4_phix --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:4" --subset phix --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex4/24135_1#4.cram --skip_markdups_metrics && qc --check alignment_filter_metrics --filename_root 24135_1#4 --qc_in \$PWD --qc_out $qc_out --rpt_list "24135:1:4" --input_files 24135_1#4_bam_alignment_filter_metrics.json && qc --check genotype_call --filename_root 24135_1#4 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:4" && qc --check substitution_metrics --filename_root 24135_1#4 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:4" --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex4/24135_1#4.cram '};
  ...
  $command = qq{bash -c ' mkdir -p $tmp_plex_dir ; cd $tmp_plex_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/24135_1#5_p4s2_pv_in.json -export_param_vals 24135_1#5_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_24135_1#5_\${log_label}.json && viv.pl -s -x -v 3 -o viv_24135_1#5_\${log_label}.log run_24135_1#5_\${log_label}.json  && qc --check bam_flagstats --filename_root 24135_1#5 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:5" --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex5/24135_1#5.cram && qc --check bam_flagstats --filename_root 24135_1#5_phix --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:5" --subset phix --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex5/24135_1#5.cram --skip_markdups_metrics && qc --check alignment_filter_metrics --filename_root 24135_1#5 --qc_in \$PWD --qc_out $qc_out --rpt_list "24135:1:5" --input_files 24135_1#5_bam_alignment_filter_metrics.json && qc --check substitution_metrics --filename_root 24135_1#5 --qc_in $qc_in --qc_out $qc_out --rpt_list "24135:1:5" --input_files $dir/171020_MS5_24135_A_MS5476963-300V2/Data/Intensities/BAM_basecalls_20171127-134427/no_cal/archive/lane1/plex5/24135_1#5.cram '};
...
subtest 'HiC_flags' => sub {
  ...
  my $command = qq{bash -c ' mkdir -p $plex_temp_dir ; cd $plex_temp_dir  &&  log_label=\$(date +%Y%m%d%H%M%S)  &&  vtfp.pl -template_path \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib -param_vals $bc_path/37416_2#1_p4s2_pv_in.json -export_param_vals 37416_2#1_p4s2_pv_out_${unique_string}_\${log_label}.json -keys cfgdatadir -vals \$(dirname \$(readlink -f \$(which vtfp.pl)))/../data/vtlib/ -keys aligner_numthreads -vals `npg_pipeline_job_env_to_threads --num_threads 12` -keys br_numthreads_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 1 --divide 2` -keys b2c_mt_val -vals `npg_pipeline_job_env_to_threads --num_threads 12 --exclude 2 --divide 2` \$(dirname \$(dirname \$(readlink -f \$(which vtfp.pl))))/data/vtlib/alignment_wtsi_stage2_template.json > run_37416_2#1_\${log_label}.json && viv.pl -s -x -v 3 -o viv_37416_2#1_\${log_label}.log run_37416_2#1_\${log_label}.json } .
