...

{
  ...
  lives_ok { $aia = npg_pipeline::function::illumina_qc_archiver->new(
  ...
  isa_ok($aia, q{npg_pipeline::function::illumina_qc_archiver}, q{$aia});
  ...
  my $expected_command = qq{bsub -q lowload -J illumina_analysis_loader_1234_20090709-123456 -R 'rusage[nfs_12=1]' -E 'npg_pipeline_script_must_be_unique_runner -job_name="illumina_analysis_loader" -own_job_name="illumina_analysis_loader_1234_20090709-123456"' -o $nfs_pbcal/log/illumina_analysis_loader_1234_20090709-123456.out 'npg_qc_illumina_analysis_loader  --id_run 1234  --run_folder 123456_IL2_1234  --runfolder_path /nfs/sf45/IL2/analysis/123456_IL2_1234  --basecall_path /nfs/sf45/IL2/analysis/123456_IL2_1234/Data/Intensities/BaseCalls  --verbose'};
